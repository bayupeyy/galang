    ...
    <div class="landing-page">
          ...
          <div class="flex items-center pt-10 px-5 md:px-0">
            <div class="w-1/2">
              ...
              <button
                ...
                class="block bg-orange-500 hover:bg-green-500 text-white font-semibold px-12 py-3 text-xl rounded-full"
              >
                Find a Project
              </button>
            </div>
            <div class="w-1/2 flex justify-center">
              <img src="/assets/images/hero-image@2x.png" alt="crowdfunding project" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="flex justify-between items-center text-center">
          <div class="w-1/3">
            <figure class="flex justify-center items-center">
              <img src="/assets/images/step-1-illustration.svg" alt="" class="h-30 mb-8" />
            </figure>
          ...
          <div class="w-1/3">
            <figure class="flex justify-center items-center -mt-24">
              <img src="/assets/images/step-2-illustration.svg" alt="" class="h-30 mb-8" />
            </figure>
            <div class="step-content">
          ...
          <div class="w-1/3">
            <figure class="flex justify-center items-center -mt-48">
              <img src="/assets/images/step-3-illustration.svg" alt="" class="h-30 mb-8" />
            </figure>
            <div class="step-content">
      ...
      <section class="container mx-auto pt-24">
        ...
        <div class="flex mt-3 -mx-6">
          <div
            class="card-project w-1/3 mx-6 my-4 p-5 border rounded-2xl"
          >
            <div class="item">
              ...
              <div class="item-meta">
                ...
                <div class="relative pt-4 progress-bar">
                  ...
                  >
                    <div
                      style="width: 20%"
                      class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-purple-500 progress-striped"
                    ></div>
                  </div>
                </div>
