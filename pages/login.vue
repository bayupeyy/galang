          ...
          <div class="w-full lg:w-1/2 px-10 lg:px-0">
            ...
            <div class="mb-6">
              <div class="mb-4">
                ...
                <input
                  type="email"
                  class="auth-form focus:outline-none focus:bg-purple-hover focus:shadow-outline focus:border-purple-hover-stroke focus:text-black-100"
            ...
            <div class="mb-6">
              <div class="mb-4">
                <button
                  ...
                  class="block w-full bg-orange-500 hover:bg-green-500 text-white font-semibold px-6 py-4 text-lg rounded-full"
                >
                  Sign In
                </button>
              </div>
            ...
            <div class="text-center">
              <p class="text-white text-md">
                Don't have account?
                <nuxt-link to="/register" class="no-underline text-orange-500"
                  >Sign Up
                  </nuxt-link>
              </p>
            </div>
